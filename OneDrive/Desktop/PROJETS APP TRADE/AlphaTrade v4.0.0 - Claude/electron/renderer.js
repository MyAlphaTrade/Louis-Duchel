...
const defaults = {
  ...
  rebond_enabled: true,
  rebond_min_contra_score: 40,
  rebond_rsi_oversold: 40,
  rebond_rsi_overbought: 60,
  rebond_max_main_score: 85,
  rebond_cooldown_sec: 900,
  ...
  symbols: {
    XAUUSD: {
      ...
      profit_target: 1.5, profit_lock_trigger: 1.0, profit_trail_pct: 20,
